...
- Follow spec-first order: update `requirements.md` → update `design.md`/tasks → implement → verify.
- Commit in order: spec update first, tasks second, implementation last.
...
- Update `design.md` if any contract, model, or layer pattern changed.
